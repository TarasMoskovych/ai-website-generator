...
- [ ] 1. Create server-side data layer and cache infrastructure
  - [ ] 1.1 Create `src/lib/serverData.ts` with Firebase Admin SDK data fetching functions
  ...
  - [ ] 1.2 Create `src/lib/cachePolicy.ts` with staleness boundary logic
  ...
  - [ ] 1.3 Write property test for showcase query filtering and sorting logic (Property 1)
  ...
  - [ ] 1.4 Write property test for cache staleness policy (Property 2)
...
- [ ] 2. Convert Showcase Page to server-side rendering
  - [ ] 2.1 Create server-rendered Showcase page component
...
- [ ] 4. Convert Login Page static content to server rendering
  ...
  - [ ] 4.3 Create `ShowcasePreviewServer` server component
