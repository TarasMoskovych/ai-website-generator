...
function GoogleSignInButton({ onClick, isLoading, disabled }: GoogleSignInButtonProps) {
  return (
    <button
      ...
      aria-busy={isLoading}
      className="flex w-full items-center justify-center gap-3 rounded-lg border border-border bg-card px-6 py-3 text-base font-medium text-card-foreground shadow-sm transition-colors hover:bg-accent focus:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:cursor-not-allowed disabled:opacity-50"
    >
      {isLoading ? (
        <>
          <div
  ...
  return (
    ...
    >
      ...
      <button
        type="button"
        onClick={onDismiss}
        className="rounded-md p-1 hover:bg-destructive/20 focus:outline-none focus-visible:ring-2 focus-visible:ring-ring"
      ...
      <div className="w-full max-w-md space-y-8">
        ...
        <div className="grid grid-cols-1 gap-4 pt-4 sm:grid-cols-3">
          <div className="text-center">
            ...
            <p className="text-muted-foreground mt-1 text-xs">Describe your vision in words</p>
          </div>
          <div className="text-center">
            <div
              className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary"
            ...
            <p className="text-muted-foreground mt-1 text-xs">Upload a design to replicate</p>
          </div>
          <div className="text-center">
            <div
              className="mx-auto mb-2 flex h-10 w-10 items-center justify-center rounded-full bg-primary/10 text-primary"
            ...
            <p className="text-muted-foreground mt-1 text-xs">Export or share your websites</p>
          </div>
        </div>
      </div>
    </main>
