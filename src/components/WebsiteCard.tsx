...
/**
 * Text/Document icon for text input type
 */
...
/**
 * Image/Screenshot icon for screenshot input type
 */
...
/**
 * Edit/Pencil icon for title editing
 */
...
/**
 * Check icon for save confirmation
 */
...
/**
 * Globe icon for shared/showcase badge
 */
